...
/* forked from byteclubfr/todotxt
 * https://github.com/byteclubfr/todotxt/blob/master/LICENSE
 */
...
function stringify(items) {
  if (Array.isArray(items)) {
    ...
    throw new Error(
      "Unexpected input: should be a TodoTxt item or list of TodoTxt items"
    );
  }
}
...
function stringifyItem(item) {
  ...
  // Completion date?
  if (item.complete && item.completeDate) {
