...
var todotxt = require("./todotxt-parser");
...
describe("TodoTxt", function () {
  ...
  describe("Parser", function () {
    ...
    it("should parse task with everything", function () {
      var item = todotxt.parse("x (B) 2015-03-20 2015-03-21 Some text with @Context and @Context and again @OtherContext attached to a +Project")[0];
  ...
  describe("Stringifier", function () {
    ...
    it("should set priority", function () {
      item.priority = "X";
      expect(todotxt.stringify(item)).toEqual("x (X) 2015-03-20 2015-03-18 Hello @Context1 @Context2 +SayHello");
    });

    it("shoud remove all contexts", function () {
      item.contexts.forEach(item.removeContext);
      expect(todotxt.stringify(item)).toEqual("x (X) 2015-03-20 2015-03-18 Hello +SayHello");
    });
